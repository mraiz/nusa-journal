  ...
  <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-lg relative z-10 p-6">
      ...
      <form @submit.prevent="submit" class="space-y-4">
         <div>
             <label class="block text-xs font-semibold text-neutral-500 uppercase mb-1">Name <span class="text-red-500">*</span></label>
             <input v-model="form.name" type="text" required class="input py-2" placeholder="e.g. Consulting Service">
         </div>
         ...
         <div>
             <label class="block text-xs font-semibold text-neutral-500 uppercase mb-1">Price (IDR)</label>
             <input v-model.number="form.price" type="number" min="0" class="input py-2 text-right font-mono" placeholder="0">
         </div>
         ...
         <div class="pt-4 border-t border-slate-100">
             ...
             <div class="space-y-3">
                 <div>
                     <label class="block text-xs font-medium text-slate-500 mb-1">Sales Account (Revenue)</label>
                 ...
                 <div>
                     <label class="block text-xs font-medium text-slate-500 mb-1">Purchase Account (Expense)</label>
