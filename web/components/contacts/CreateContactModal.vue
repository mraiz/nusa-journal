  ...
  <div v-if="show" class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-lg relative z-10 p-6">
      <div class="flex items-center justify-between mb-6">
         <h3 class="text-lg font-bold text-slate-900">{{ initialData ? 'Edit' : 'New' }} {{ type === 'CUSTOMER' ? 'Customer' : 'Vendor' }}</h3>
      ...
      <form @submit.prevent="submit" class="space-y-4">
         <div class="grid grid-cols-3 gap-4">
             <div class="col-span-2">
                 ...
                 <input v-model="form.name" type="text" required class="input py-2" placeholder="e.g. Acme Corp">
             </div>
             <div>
         ...
         <div class="grid grid-cols-2 gap-4">
             <div>
                 ...
                 <input v-model="form.email" type="email" class="input py-2" placeholder="john@example.com">
             </div>
             <div>
         ...
         <div>
             ...
             <textarea v-model="form.address" rows="3" class="input py-2" placeholder="Full address..."></textarea>
         </div>
