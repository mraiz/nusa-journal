  ...
  <NuxtLayout name="dashboard">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
      ...
      <div class="flex gap-2">
        <NuxtLink :to="`/${slug}/journals/create`" class="btn btn-primary flex items-center gap-2">
    ...
    <div class="glass-card overflow-hidden">
      <!-- Toolbar -->
      <div class="p-4 border-b border-neutral-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-neutral-50/50">
        <!-- Search -->
      ...
      <table v-else class="w-full">
        ...
        <tbody class="divide-y divide-neutral-100">
          <tr v-for="journal in journalStore.journals" :key="journal.id" class="hover:bg-primary-50/30 transition-colors">
            ...
            <td class="px-6 py-4 text-sm text-neutral-800 text-right font-mono">
              ...
              <NuxtLink :to="`/${slug}/journals/${journal.id}`" class="p-2 text-neutral-400 hover:text-primary-600 hover:bg-primary-50 rounded-lg transition-colors inline-block flex justify-center items-center" title="Lihat Detail">
