  ...
  <div>
    ...
    <div class="flex gap-4 border-b border-slate-200 mb-6">
      ...
      >
        ...
        <div v-if="activeTab === tab" class="absolute bottom-0 left-0 w-full h-0.5 bg-primary-500"></div>
      </button>
    </div>
    ...
    <div v-else class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col h-full">
        ...
        <div v-if="currentList?.length === 0 && !loading">
            <EmptyState
                ...
                :description="activeTab === 'CUSTOMERS' ? 'Add customers to track sales and receivables.' : 'Add vendors to track expenses and payables.'"
