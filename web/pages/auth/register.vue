<template>
  <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div class="absolute top-20 -left-20 w-96 h-96 bg-accent-300/20 rounded-full blur-3xl animate-float"></div>
      <div class="absolute bottom-20 -right-20 w-96 h-96 bg-primary-300/20 rounded-full blur-3xl animate-float" style="animation-delay: 1s;"></div>
    </div>
    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <div class="glass-card p-8 animate-scale-in">
        ...
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-accent-500 to-primary-500 rounded-2xl mb-4 shadow-glow-green">
        ...
        <form @submit.prevent="handleRegister" class="space-y-5">
          ...
          <div class="flex items-start gap-2">
            <input type="checkbox" required class="mt-1 w-4 h-4 rounded border-neutral-300 text-primary-600 focus:ring-primary-500">
        ...
        <div class="mt-6 text-center">
          <NuxtLink to="/auth/login" class="btn btn-secondary w-full">
            Masuk ke Akun
          </NuxtLink>
        </div>
      </div>
