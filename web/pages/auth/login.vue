<template>
  <div class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    ...
    <div class="absolute inset-0 overflow-hidden pointer-events-none">
      <div
        class="absolute top-20 -left-20 w-96 h-96 bg-primary-300/20 rounded-full blur-3xl animate-float"
      ></div>
      <div
        class="absolute bottom-20 -right-20 w-96 h-96 bg-accent-300/20 rounded-full blur-3xl animate-float"
        style="animation-delay: 1s"
      ></div>
      <div
        class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-primary-200/10 rounded-full blur-3xl animate-float"
    ...
    <div class="w-full max-w-md relative z-10">
      ...
      <div class="glass-card p-8 animate-scale-in">
        ...
        <div class="text-center mb-8">
          <div
            class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary-500 to-accent-500 rounded-2xl mb-4 shadow-glow-blue"
          >
              ...
              >
                ...
                <svg v-else class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    ...
                    stroke-linejoin="round"
                    stroke-width="2"
                    d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.05 10.05 0 011.574-2.874m5.05-5.05A10.05 10.05 0 0112 5c4.478 0 8.268 2.943 9.542 7a10.05 10.05 0 01-1.574 2.874M9 15l3-3m0 0l3-3m-3 3a3 3 0 100-6 3 3 0 000 6z"
                  />
                </svg>
              </button>
            </div>
