...
export class PeriodController {
  ...
  async createPeriod(@Body(ValidationPipe) dto: CreatePeriodDto) {
  ...
  async closePeriod(@Param("id") id: string, @CurrentUser() user: any) {
    return this.closingService.closePeriod(id, {
      userId: user.userId,
      email: user.email,
    });
  }
